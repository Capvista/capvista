    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F6F8FA" }}>
      ...
      <main className="container py-20 max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-gray-600 leading-relaxed">
          <p>
            Capvista is committed to protecting the privacy and security of your
            personal information. This policy describes how we collect, use, and
            safeguard data when you use our platform.
          </p>
          <p className="text-sm text-gray-400 pt-8 border-t border-gray-200">
            Full privacy policy is currently being finalized. For questions,
            contact{" "}
            <a
